...
/**
 * The App configuration. Subclasses may add additional properties or change the configuration such as the application layout.
 */
public class AppConfiguration extends DromblerClientConfiguration {
     ...
     */
    public AppConfiguration(CommandLineArgs commandLineArgs) throws URISyntaxException, IOException,
            MissingPropertyException {
        super(commandLineArgs);
    }

    /**
     * Determines the installation directory path of this application. This app expects the following application installation layout: {@code <install-dir>/bin/lib/<jar>}
     *
    ...
    protected Properties loadDefaultConfigProps() throws IOException {
        ...
        try (InputStream is = AppConfiguration.class.getResourceAsStream("config.properties")) {
            properties.load(is);
        }
        return properties;
    }
